...
An application for recognizing free parking spaces using M-RCNN. User provides photo or video data to process and fimd free parking spaces on it. Containerized in Docker. +
